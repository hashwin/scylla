...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/scylla/lms/albanian.lm",
    "lib/scylla/lms/amharic-utf.lm",
    "lib/scylla/lms/arabic.lm",
    "lib/scylla/lms/armenian.lm",
    "lib/scylla/lms/basque.lm",
    "lib/scylla/lms/belarus-windows1251.lm",
    "lib/scylla/lms/bosnian.lm",
    "lib/scylla/lms/breton.lm",
    "lib/scylla/lms/bulgarian-iso8859_5.lm",
    "lib/scylla/lms/catalan.lm",
    "lib/scylla/lms/chinese.lm",
    "lib/scylla/lms/croatian-ascii.lm",
    ...
    "lib/scylla/lms/japanese-euc_jp.lm",
    "lib/scylla/lms/japanese-shift_jis.lm",
    "lib/scylla/lms/japanese.lm",
    "lib/scylla/lms/korean.lm",
    "lib/scylla/lms/latin.lm",
    "lib/scylla/lms/latvian.lm",
    "lib/scylla/lms/lithuanian.lm",
    "lib/scylla/lms/malay.lm",
    "lib/scylla/lms/manx.lm",
    ...
    "lib/scylla/lms/slovak-windows1250.lm",
    "lib/scylla/lms/slovenian-ascii.lm",
    "lib/scylla/lms/slovenian-iso8859_2.lm",
    ...
    "source_texts/japanese-euc_jp.txt",
    "source_texts/japanese-shift_jis.txt",
    "source_texts/japanese.txt",
    "source_texts/korean.txt",
    "source_texts/latin.txt",
    "source_texts/latvian.txt",
    "source_texts/lithuanian.txt",
    "source_texts/malay.txt",
    "source_texts/manx.txt",
    ...
    "source_texts/slovak-windows1250.txt",
    "source_texts/slovenian-ascii.txt",
    "source_texts/slovenian-iso8859_2.txt",
